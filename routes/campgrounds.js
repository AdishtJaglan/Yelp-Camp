...
router.route("/")
    ...
    .post(isLoggedIn, upload.array("image"), validateCampground, asyncError(campground.createCampground)); //create a new campground
...
router.route("/:id")
    ...
    .put(isLoggedIn, isAuthor, upload.array("image"), validateCampground, asyncError(campground.displayUpdatedCampground)) //display updated campground
